    ...
    def update(self, layer):
        ...
        for n, dv in layer.grads.items():
            if n in self.cache.keys():
                ...
                self.cache[n] = (1 - self.decay) * layer.grads[n] ** 2
            layer.params[n] -= self.lr * dv / (self.cache[n] + self.eps) ** 0.5
